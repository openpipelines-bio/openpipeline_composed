// cellranger_multi_qc build_main
// 
...
include { cellranger_multi } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v4.2.0/nextflow/workflows/ingestion/cellranger_multi/main.nf"
