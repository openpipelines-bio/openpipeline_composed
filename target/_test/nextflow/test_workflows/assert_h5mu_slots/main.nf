...
meta = [
  ...
  "argument_groups" : [
      ...
      "arguments" : [
        {
          "type" : "file",
          "name" : "--input",
          "description" : "Output h5mu file to validate.",
          "example" : [
            "output.h5mu"
          ],
          "must_exist" : true,
        ...
        },
        {
          "type" : "string",
          "name" : "--modality",
          "description" : "Modality to inspect.",
          "default" : [
            "rna"
          ],
          "required" : false,
      ...
      "arguments" : [
        {
          "type" : "string",
          "name" : "--obs",
          "description" : "Expected .obs column names.",
          "required" : false,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ";"
        },
        {
          "type" : "string",
          "name" : "--obsm",
          "description" : "Expected .obsm keys.",
          "required" : false,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ";"
        },
        {
          "type" : "string",
          "name" : "--obsp",
          "description" : "Expected .obsp keys.",
          "required" : false,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ";"
    ...
    {
      "name" : "Unexpected slots",
      "arguments" : [
        {
          "type" : "string",
          "name" : "--obs_absent",
          "description" : ".obs column names that must not be present.",
          "required" : false,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ";"
        },
        {
          "type" : "string",
          "name" : "--obsm_absent",
          "description" : ".obsm keys that must not be present.",
          "required" : false,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ";"
        },
        {
          "type" : "string",
          "name" : "--obsp_absent",
          "description" : ".obsp keys that must not be present.",
          "required" : false,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ";"
        },
        {
          "type" : "string",
          "name" : "--uns_absent",
          "description" : ".uns keys that must not be present.",
          "required" : false,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ";"
  ...
  "description" : "Test helper. Reads a modality from an output h5mu and asserts that the expected\n.obs columns, .obsm keys, .obsp keys and .uns keys are all present, and that any\nslots listed as absent are not present. Raises an error listing any missing slots\n(expected but absent) or unexpected slots (listed as absent but present).\n",
  "status" : "enabled",
  "scope" : {
    "image" : "test",
    "target" : "test"
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_composed/openpipeline_composed/src/test_workflows/assert_h5mu_slots/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'obs_absent': $( if [ ! -z ${VIASH_PAR_OBS_ABSENT+x} ]; then echo "r'${VIASH_PAR_OBS_ABSENT//\\'/\\'\\"\\'\\"r\\'}'.split(';')"; else echo None; fi ),
  'obsm_absent': $( if [ ! -z ${VIASH_PAR_OBSM_ABSENT+x} ]; then echo "r'${VIASH_PAR_OBSM_ABSENT//\\'/\\'\\"\\'\\"r\\'}'.split(';')"; else echo None; fi ),
  'obsp_absent': $( if [ ! -z ${VIASH_PAR_OBSP_ABSENT+x} ]; then echo "r'${VIASH_PAR_OBSP_ABSENT//\\'/\\'\\"\\'\\"r\\'}'.split(';')"; else echo None; fi ),
  'uns_absent': $( if [ ! -z ${VIASH_PAR_UNS_ABSENT+x} ]; then echo "r'${VIASH_PAR_UNS_ABSENT//\\'/\\'\\"\\'\\"r\\'}'.split(';')"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline_composed/test_workflows/assert_h5mu_slots",
    "tag" : "build_main"
  },
  "label" : [
    "singlecpu",
