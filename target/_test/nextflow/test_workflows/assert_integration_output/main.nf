// assert_integration_output build_main
// 
...
meta = [
  ...
  "name" : "assert_integration_output",
  ...
  "description" : "Test helper for the parallel_integration workflow. Reads a modality from an\noutput h5mu and asserts that the expected .obs columns, .obsm keys, .obsp keys\nand .uns keys are all present. Raises an error listing any missing slots.\n",
  "status" : "enabled",
  "scope" : {
    "image" : "test",
    "target" : "test"
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_composed/openpipeline_composed/src/test_workflows/assert_integration_output/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "/home/runner/work/openpipeline_composed/openpipeline_composed/target/_test/nextflow/test_workflows/assert_integration_output",
    "viash_version" : "0.9.7",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline_composed/test_workflows/assert_integration_output",
    "tag" : "build_main"
  },
  "label" : [
    "singlecpu",
