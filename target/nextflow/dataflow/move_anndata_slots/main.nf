...
meta = [
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "description" : "Modality in the target h5mu file to write slots into.\nDefaults to the value of --source_modality.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
      ...
      "arguments" : [
        {
          "type" : "string",
          "name" : "--obs",
          "description" : "Column names from .obs to move from the source modality to the\ntarget modality. If not provided, .obs is not moved.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ";"
        },
        {
          "type" : "string",
          "name" : "--var",
          "description" : "Column names from .var to move from the source modality to the\ntarget modality. If not provided, .var is not moved.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ";"
        },
        {
          "type" : "string",
          "name" : "--obsm",
          "description" : "Keys from .obsm to move from the source modality to the target\nmodality. If not provided, .obsm is not moved.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ";"
        },
        {
          "type" : "string",
          "name" : "--varm",
          "description" : "Keys from .varm to move from the source modality to the target\nmodality. If not provided, .varm is not moved.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ";"
        },
        {
          "type" : "string",
          "name" : "--obsp",
          "description" : "Keys from .obsp to move from the source modality to the target\nmodality. If not provided, .obsp is not moved.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ";"
        },
        {
          "type" : "string",
          "name" : "--varp",
          "description" : "Keys from .varp to move from the source modality to the target\nmodality. If not provided, .varp is not moved.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ";"
        },
        {
          "type" : "string",
          "name" : "--uns",
          "description" : "Keys from .uns to move from the source modality to the target\nmodality. If not provided, .uns is not moved.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ";"
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_composed/openpipeline_composed/src/dataflow/move_anndata_slots/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  'input_source': $( if [ ! -z ${VIASH_PAR_INPUT_SOURCE+x} ]; then echo "r'${VIASH_PAR_INPUT_SOURCE//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'source_modality': $( if [ ! -z ${VIASH_PAR_SOURCE_MODALITY+x} ]; then echo "r'${VIASH_PAR_SOURCE_MODALITY//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'input_target': $( if [ ! -z ${VIASH_PAR_INPUT_TARGET+x} ]; then echo "r'${VIASH_PAR_INPUT_TARGET//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'target_modality': $( if [ ! -z ${VIASH_PAR_TARGET_MODALITY+x} ]; then echo "r'${VIASH_PAR_TARGET_MODALITY//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/openpipeline_composed/dataflow/move_anndata_slots",
    "tag" : "build_main"
  },
  "label" : [
    "singlecpu",
