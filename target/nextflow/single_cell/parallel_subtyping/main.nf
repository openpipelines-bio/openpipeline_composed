...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "file",
          "name" : "--input",
          "description" : "Input query h5mu file with a major cell-type annotation. Must be\npreprocessed in the same way as the reference.\n",
          "example" : [
            "input.h5mu"
          ],
          "must_exist" : true,
        ...
        },
        {
          ...
          "description" : ".var column containing gene names. By default the .var index is used.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
        ...
        },
        {
          ...
          "description" : ".obs column(s) in the input query with continuous (numerical) covariates for\nscanvi_scarches to correct for in addition to the batch label. Treated as\nnuisance factors; their order must match --reference_obs_numerical_covariates.\nNone by default.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ";"
      ...
      "arguments" : [
        {
          "type" : "file",
          "name" : "--reference",
          "description" : "Reference h5mu file with labeled observations. Used by all annotation\nmethods (celltypist, harmony_knn, scanvi_scarches and scvi_knn).\n",
          "example" : [
            "reference.h5mu"
          ],
          "must_exist" : true,
        ...
        },
        {
          ...
          "description" : ".obs column(s) in the reference with categorical covariates for\nscanvi_scarches to correct for in addition to the batch label. Treated as\nnuisance factors; their order must match --input_obs_categorical_covariates.\nNone by default.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ";"
        },
        {
          ...
          "description" : ".obs column(s) in the reference with continuous (numerical) covariates for\nscanvi_scarches to correct for in addition to the batch label. Treated as\nnuisance factors; their order must match --input_obs_numerical_covariates.\nNone by default.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ";"
    ...
    },
    {
      ...
      "description" : "Training arguments shared by scanvi_scarches and scvi_knn.\n",
      "arguments" : [
        {
          "type" : "boolean",
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "description" : "Minimum proportion of cells in a sub-cluster supporting a label for\nmajority voting; only relevant if --celltypist_majority_voting is set.\n",
          "default" : [
            0.0
          ],
          "required" : false,
    ...
    },
    {
      ...
      "description" : "Names of the .obs and .obsm slots each method writes to the subtyped output.\n",
      "arguments" : [
        {
          "type" : "string",
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_composed/openpipeline_composed/src/single_cell/parallel_subtyping/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "/home/runner/work/openpipeline_composed/openpipeline_composed/target/nextflow/single_cell/parallel_subtyping",
    "viash_version" : "0.9.7",
...
include { parallel_annotation } from "${meta.resources_dir}/../../../nextflow/single_cell/parallel_annotation/main.nf"
include { split_modalities } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v4.2.0/nextflow/dataflow/split_modalities/main.nf"
include { split_h5mu } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v4.2.0/nextflow/dataflow/split_h5mu/main.nf"
include { concatenate_h5mu } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v4.2.0/nextflow/dataflow/concatenate_h5mu/main.nf"
include { merge } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v4.2.0/nextflow/dataflow/merge/main.nf"
include { add_id } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v4.2.0/nextflow/metadata/add_id/main.nf"
