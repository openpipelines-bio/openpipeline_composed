// parallel_annotation build_main
// 
...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "file",
          "name" : "--input",
          "description" : "Input query h5mu file. Must be preprocessed in the same way as the\nreference (raw counts and log-normalized counts available).\n",
          "example" : [
            "input.h5mu"
          ],
          "must_exist" : true,
      ...
      "arguments" : [
        {
          "type" : "file",
          "name" : "--reference",
          "description" : "Reference h5mu file with labeled observations. Required by harmony_knn,\nscanvi_scarches, scvi_knn, and by celltypist when --celltypist_model\nis not provided.\n",
          "example" : [
            "reference.h5mu"
          ],
          "must_exist" : true,
    ...
    },
    {
      ...
      "description" : "Training arguments shared by scanvi_scarches and scvi_knn. (scvi_knn maps\nthese to its --scvi_* prefixed arguments at dispatch time.)\n",
      "arguments" : [
        {
          "type" : "boolean",
      ...
      "arguments" : [
        {
          ...
          "description" : "Pretrained CellTypist model in .pkl format. If not provided, the\nmodel is trained on --reference.\n",
          "example" : [
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_composed/openpipeline_composed/src/single_cell/parallel_annotation/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
...
include { celltypist as celltypist_annotation_viashalias } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v4.1.0/nextflow/workflows/annotation/celltypist/main.nf"
celltypist_annotation = celltypist_annotation_viashalias.run(key: "celltypist_annotation")
include { harmony_knn as harmony_knn_annotation_viashalias } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v4.1.0/nextflow/workflows/annotation/harmony_knn/main.nf"
...
include { scvi_knn as scvi_knn_annotation_viashalias } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v4.1.0/nextflow/workflows/annotation/scvi_knn/main.nf"
scvi_knn_annotation = scvi_knn_annotation_viashalias.run(key: "scvi_knn_annotation")
include { singler as singler_annotation_viashalias } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v4.1.0/nextflow/annotate/singler/main.nf"
