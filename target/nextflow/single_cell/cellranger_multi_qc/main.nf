// cellranger_multi_qc build_set_public_scope
// 
...
meta = [
  ...
  "version" : "build_set_public_scope",
  "authors" : [
    {
      "name" : "Jakub Majercik",
      "roles" : [
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "description" : "Ingestion QC report in HTML format. Generated when --create_sample_qc_report is true.\n",
          "example" : [
        ...
        },
        {
          ...
          "description" : "Folder containing the QC-processed h5mu files. Generated when\n--create_sample_qc_report is true.\n",
          "example" : [
            "processed_h5mu"
          ],
          "must_exist" : true,
        ...
        },
        {
          ...
          "description" : "MultiQC report in HTML format. Generated when\n--create_multiqc_report is true.\n",
          "example" : [
            "multiqc_report.html"
          ],
          "must_exist" : true,
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "description" : "Whether to run FastQC on the input FASTQ files and aggregate results\ninto a MultiQC report.\n",
          "default" : [
            true
          ],
          "required" : false,
        ...
        },
        {
          "type" : "boolean",
          "name" : "--run_cellbender",
          "description" : "Whether to run CellBender for ambient RNA removal as part of the\nsample QC report generation. Only used when --create_sample_qc_report is true.\n",
          "default" : [
            false
          ],
          "required" : false,
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_composed/openpipeline_composed/src/single_cell/cellranger_multi_qc/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "/home/runner/work/openpipeline_composed/openpipeline_composed/target/nextflow/single_cell/cellranger_multi_qc",
    "viash_version" : "0.9.7",
    "git_commit" : "124d05a862f21241f4bc478fff13f75f6d3d641e",
