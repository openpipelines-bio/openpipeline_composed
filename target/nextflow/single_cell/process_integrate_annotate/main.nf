// process_integrate_annotate build_main
// 
...
meta = [
  ...
  "build_info" : {
    ...
    "viash_version" : "0.9.4",
    "git_commit" : "62cf32112111f005bd65331ecfe6c69ba797c405",
...
include { process_samples as process_samples_workflow_viashalias } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v3.0.0/nextflow/workflows/multiomics/process_samples/main.nf"
process_samples_workflow = process_samples_workflow_viashalias.run(key: "process_samples_workflow")
include { celltypist as celltypist_annotation_viashalias } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v3.0.0/nextflow/annotate/celltypist/main.nf"
celltypist_annotation = celltypist_annotation_viashalias.run(key: "celltypist_annotation")
include { scanvi_scarches as scanvi_scarches_annotation_viashalias } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v3.0.0/nextflow/workflows/annotation/scanvi_scarches/main.nf"
scanvi_scarches_annotation = scanvi_scarches_annotation_viashalias.run(key: "scanvi_scarches_annotation")
include { harmony_leiden as harmony_integration_viashalias } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v3.0.0/nextflow/workflows/integration/harmony_leiden/main.nf"
harmony_integration = harmony_integration_viashalias.run(key: "harmony_integration")
include { scvi_leiden as scvi_integration_viashalias } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v3.0.0/nextflow/workflows/integration/scvi_leiden/main.nf"
