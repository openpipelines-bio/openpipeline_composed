// parallel_integration build_main
// 
...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "file",
          "name" : "--input",
          "description" : "Input preprocessed h5mu file. Must contain a log-normalized layer and\na PCA embedding (or the embedding specified via --obsm_embedding).\n",
          "example" : [
            "input.h5mu"
          ],
          "must_exist" : true,
        ...
        },
        {
          ...
          "description" : "Layer with the log-normalized counts. Read by the methods that operate\non normalized expression: harmony, scanorama and bbknn.\n",
          "default" : [
            "log_normalized"
          ],
          "required" : false,
        ...
        },
        {
          "type" : "string",
          "name" : "--obsm_embedding",
          "description" : ".obsm slot containing the embedding to use as input for methods that\nrequire a pre-computed dimensionality reduction (harmony, scanorama, bbknn).\n",
          "default" : [
            "X_pca"
          ],
          "required" : false,
        ...
        },
        {
          "type" : "string",
          "name" : "--obs_batch",
          "description" : ".obs column discriminating between batches. Read by scVI, scanorama and bbknn.\n",
          "default" : [
            "sample_id"
          ],
          "required" : false,
        ...
        },
        {
          "type" : "string",
          "name" : "--obs_covariates",
          "description" : ".obs column(s) defining the covariates to regress out. Read by harmony.\n",
          "default" : [
            "sample_id"
          ],
          "required" : false,
        ...
        },
        {
          "type" : "string",
          "name" : "--var_input",
          "description" : ".var column containing highly variable genes to subset to. Read by scVI.\nBy default, scVI uses all genes.\n",
          "required" : false,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
      ...
      "arguments" : [
        {
          ...
          "description" : "Leiden clustering resolution(s). Each method will produce one .obs\ncluster column per resolution, named \\"{method}_integration_leiden_{resolution}\\".\n",
          "default" : [
            1.0
          ],
          "required" : false,
      ...
      "arguments" : [
        {
          "type" : "double",
          "name" : "--harmony_theta",
          "description" : "Diversity clustering penalty. Higher values produce more diverse clusters.\n",
          "default" : [
            2.0
          ],
          "required" : false,
      ...
      "arguments" : [
        {
          ...
          "description" : "Output h5mu file — the input preprocessed file with each selected\nmethod's annotations merged into the target modality.\n",
          "example" : [
            "output.h5mu"
          ],
          "must_exist" : true,
  ...
  "build_info" : {
    "config" : "/home/runner/work/openpipeline_composed/openpipeline_composed/src/single_cell/parallel_integration/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
...
include { scanorama_leiden as scanorama_integration_viashalias } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v4.2.0/nextflow/workflows/integration/scanorama_leiden/main.nf"
scanorama_integration = scanorama_integration_viashalias.run(key: "scanorama_integration")
include { bbknn_leiden as bbknn_integration_viashalias } from "${meta.root_dir}/dependencies/vsh/vsh/openpipeline/v4.2.0/nextflow/workflows/integration/bbknn_leiden/main.nf"
