...
meta = [
  ...
  "build_info" : {
    "config" : "/workdir/root/repo/src/feature_annotation/align_query_reference/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker|native",
    "output" : "/workdir/root/repo/target/nextflow/feature_annotation/align_query_reference",
    "viash_version" : "0.9.7",
    "git_commit" : "400010e14882761b2e73cf96df1d06dd8fa1afa5",
  ...
  "package_config" : {
    ...
    "config_mods" : [
      ...
      ".engines[.type == 'docker'].target_tag := 'v4.1.1'"
    ],
    "keywords" : [
      "single-cell",
      "multimodal"
...
meta["defaults"] = [
  ...
  "container" : {
    ...
    "image" : "vsh/openpipeline/feature_annotation/align_query_reference",
    "tag" : "v4.1.1"
  },
  "label" : [
    "lowcpu",
