...
meta = [
  ...
  "build_info" : {
    "config" : "/workdir/root/repo/src/workflows/ingestion/cellranger_multi/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "/workdir/root/repo/target/nextflow/workflows/ingestion/cellranger_multi",
    "viash_version" : "0.9.7",
