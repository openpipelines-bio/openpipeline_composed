...
meta = [
  ...
  "build_info" : {
    "config" : "/workdir/root/repo/src/workflows/annotation/scanvi_scarches/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "/workdir/root/repo/target/nextflow/workflows/annotation/scanvi_scarches",
    "viash_version" : "0.9.7",
