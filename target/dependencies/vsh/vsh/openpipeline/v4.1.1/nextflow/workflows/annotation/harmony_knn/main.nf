...
meta = [
  ...
  "build_info" : {
    "config" : "/workdir/root/repo/src/workflows/annotation/harmony_knn/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "/workdir/root/repo/target/nextflow/workflows/annotation/harmony_knn",
    "viash_version" : "0.9.7",
